...
class CNN(nn.Module):
    def __init__(self, num_classes,dim_input=13,dim_hidden=128,dim_output=128,kernel_size=3):
        ...
        self.fc1 = nn.Linear(128*161, dim_output)
        self.fc2 = nn.Linear(dim_output, num_classes)
...
if __name__ == "__main__":
    ...
    model = TCN(input_size=13, num_channels=[32, 64, 32],output_size=10, kernel_size=3, dropout=0.1).to(device)
